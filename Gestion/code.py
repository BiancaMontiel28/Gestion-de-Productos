    ...
    for producto in productos:
        if producto["nombre"].lower() == nombre.lower():
            ...
            if nuevo_nombre:  
                ...
                print(f"Nombre del producto actualizado a '{nuevo_nombre}' con éxito.")
                
            if nuevo_precio:  
                try:
                    producto["precio"] = float(nuevo_precio)
                    print(f"Precio del producto '{producto['nombre']}' actualizado a {producto['precio']} con éxito.")
                except ValueError:
            ...
            if nuevo_cantidad:  
                try:
                    ...
                    print(f"Cantidad del producto '{producto['nombre']}' actualizada a {producto['cantidad']} con éxito.")
                except ValueError:
